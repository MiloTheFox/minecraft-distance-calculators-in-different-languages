C, C++, Go and Rust example implementations for the [Original Distance Calculator written in Java](https://github.com/Sweet-Tooth11/minecraft-distance-calculator)
...
### C, C++, Go, Java, Javascript, Rust, Typescript
